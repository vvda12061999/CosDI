...
Cocos Creator 3.0+ editor panel for [CosDI](https://github.com/vvda12061999/CosDI). It shows the live scope tree, registrations, each scope's dependency graph and `CosDIBenchmarkRunner` results while you play a scene.
